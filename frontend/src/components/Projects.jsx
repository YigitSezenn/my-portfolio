...
const Projects = () => {
  ...
  return (
    <section id="projects" className="min-h-screen px-6 py-20 relative overflow-hidden">
      ...
      <div className="absolute top-20 right-0 w-96 h-96 bg-white opacity-[0.02] rounded-full blur-[100px] pointer-events-none" />
          ...
          >
            {projects.map((project, index) => (
              ...
              >
                ...
                <Card
                  className="bg-[#1f1f1f]/80 backdrop-blur-sm border-[#2d2d2d] hover:border-[#404040] transition-all duration-300 cursor-pointer h-full relative overflow-hidden"
                ...
                >
                  ...
                  <CardHeader className="relative z-10">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      >
                        <Code className="text-[#a3a3a3] group-hover:text-white transition-colors duration-300" size={24} />
                      </motion.div>
                      <motion.div
                        whileHover={{ x: 5, y: -5 }}
                        transition={{ type: "spring", stiffness: 300 }}
                      >
                        <ExternalLink className="text-[#a3a3a3] group-hover:text-white transition-colors duration-300" size={18} />
                      </motion.div>
                    </div>
                    <CardTitle className="text-white text-xl mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-gray-400 transition-all duration-300">
                      {project.name}
                    </CardTitle>
                      ...
                      <div className="flex flex-wrap gap-2 mt-4">
                        {project.topics.slice(0, 3).map((topic, idx) => (
                          <motion.span
                            ...
                            className="text-xs px-2 py-1 bg-[#2d2d2d] text-[#a3a3a3] rounded transition-all duration-200"
                          >
                            {topic}
                          </motion.span>
                        ))}
